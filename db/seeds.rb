...
Element.create(category: 'p', name: "Tell us about yourself", value: 'I have been teaching for 10 years and guide students to achieve their own goals', section: bio)
Element.create(category: 'img', name: 'Upload a profile picture', value: 'https://avatars3.githubusercontent.com/u/4753571?v=4', section: bio)
